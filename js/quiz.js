...
const products = [
  {
    ...
    url: 'https://amzn.to/445YjHw',
    image: '/public/images/cleanser1.jpg',
    hoverImage: '/public/images/foam-cleanser.jpg',
    ingredients: ['Isopropyl Palmitate', 'Fragrance', 'Herbal Oil Complex'],
    ecoFriendly: false,
    notes:
      'Highly effective at melting waterproof makeup and sunscreen; emulsifies easily, leaving skin soft and hydrated. Contains fragrance and mildly comedogenic oil — patch test if acne‑prone. Some users noted slight eye irritation if it seeps into eyes.',
    pros: [
  ...
  },
  {
    ...
    ecoFriendly: true,
    notes:
      'Lightweight, well‑rated hydrating cleansing oil. Removes most makeup & sunscreen, leaving slight film—best for everyday wear, not heavy waterproof makeup. Contains fragrance & alcohol, so may irritate very sensitive skin.',
    pros: [
...
Only really available internationally, but is a cult classic, going to just use the available green tea one for now.
{
  ...
  }, */
  {
    ...
    image: '/public/images/serum.jpg',
    hoverImage: '/public/images/serum-hover.jpg',
    ingredients: [
      'Propolis Extract',
      'Niacinamide',
      'Turmeric',
    ...
    ecoFriendly: false,
    notes:
      'Popular budget serum with propolis & niacinamide. Brightens and hydrates without stickiness. Many users love the glow; some oily‑skin users may find it too dewy. A few report breakouts or texture reactions.',
    pros: [
  ...
  },
  {
    ...
    hoverImage: '/public/images/mask-hover.jpg',
  ...
  },
  {
    ...
    image: '/public/images/toner.jpg',
    hoverImage: '/public/images/toner-hover.jpg',
    ingredients: [
      'Willow Bark Water',
      'Glycolic Acid',
      'Betaine Salicylate',
  ...
  },
  {
    ...
    ageGroup: ['All'],
    sensitivities: ['None'],
    url: 'https://amzn.to/471dlRK',
    image: '/public/images/essence.jpg',
    hoverImage: '/public/images/essence-hover.jpg',
    ingredients: [
...

  {
    ...
    image: '/public/images/ampoule.jpg',
    hoverImage: '/public/images/ampoule-hover.jpg',
    ingredients: [
      'Niacinamide',
      'Adenosine',
  ...
  },
  {
    ...
    image: '/public/images/cream.jpg',
    hoverImage: '/public/images/cream-hover.jpg',
  ...
  },
  {
    ...
    image: '/public/images/lotion.jpg',
    hoverImage: '/public/images/lotion-hover.jpg',
  ...
  },
  {
    ...
    image: '/public/images/sunscreen.jpg',
    hoverImage: '/public/images/sunscreen-hover.jpg',
    ingredients: [
      'Rice Extract',
      'Probiotics',
      'Niacinamide',
  ...
  }, */
  {
    ...
    image: '/public/images/lip-mask.jpg',
    hoverImage: '/public/images/lip-mask-hover.jpg',
    ingredients: [
      'Berry Fruit Complex™',
  ...
  },
  {
    ...
    cons: ['Single-use plastic sleeve', 'Not effective on cystic, deep nodules']
  },
  {
    id: 45,
    name: 'Neogen Bio-Peel Gauze Peeling Pads, Lemon',
    category: 'Exfoliator',
    ...
    image: '/public/images/pads.jpg',
    hoverImage: '/public/images/pads-hover.jpg',
    ingredients: [
      'Lactic Acid',
      'Glycolic Acid',
      'Lemon Fruit Extract',
...
function getRecommendedProducts (userAnswers) {
  ...
  const scoredProducts = products.map(product => {
    ...
    if (userAnswers.skinType === 'Sensitive') {
      ...
      breakdown.sensitivePenalty = -extraHits * weights.sensitiveHitPerIrritant
      ...
      try {
        ...
        if (quizCompleted === 'true') {
          ...
          if (storedProducts.length && Object.keys(storedRoutine).length) {
            ...
            return // <-- avoid the normal “resume-quiz” code path
          }
        }
...
──────────────────────────────────────────────────────────────────── */
    ...
    function generateRoutine (userAnswers, allSortedProducts) {
      ...
      const stepHowTo = {
        ...
        Tone: 'Sweep toner across your face and neck with clean hands or a cotton pad and allow it to fully absorb.',
        ...
        Mask: 'Spread a thin, even layer of mask onto clean skin, leave it on for the recommended time, and then rinse or remove according to the product directions.'
      }
      ...
      const build = steps =>
        steps.map(s => {
          ...
          return {
            ...
            ecoFriendly:
              typeof prod?.ecoFriendly === 'boolean' ? prod.ecoFriendly : null,
                  ...
                  step.productImg
                    ? `<div class="routine-product">
                        ...
                        <div class="routine-product-info">
                          ...
                          <p class="instructions hover-info">${
                            step.instructions
                          }</p>
